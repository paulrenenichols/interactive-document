...
export interface ChartsTableProps {
  ...
  /** Authoring: opens the in-canvas chart creation wizard (e.g. Data Model workspace). */
  onNewChart?: () => void;
}

/** Full-width ledger table for global chart assets (Stitch: “Global Charts” section). */
export function ChartsTable({ rows, draggableCharts = false, onNewChart }: ChartsTableProps) {
