...
**Document locations:** Keep all docs under `_docs/`. Put the project overview in `_docs/planning/milestones/00-initial-milestones/project-overview/` (e.g. `overview.md`). Put the definition docs (user flow, auth, tech stack, UI, theme, project rules) in `_docs/planning/milestones/00-initial-milestones/definition/`. Put milestones in `_docs/milestones/`. Put setup guides in `_docs/planning/setup/`. This structure keeps overview, definition, setup, and milestones easy to find and reuse across projects.

1. `_docs/planning/milestones/00-initial-milestones/project-overview/overview.md` (or `project-overview.md`)

   - Establish overall project purpose, scope, and goals.

2. `_docs/planning/milestones/00-initial-milestones/definition/user-flow.md`

   - Clarify how users will interact with the application (landing, registration, navigation, redirects, registration, etc).

3. `_docs/planning/milestones/00-initial-milestones/definition/auth.md`

   - Describe how authentication works in the app.

4. `_docs/planning/milestones/00-initial-milestones/definition/tech-stack.md`

   - Describe the core technologies used (Node, Next.js, TypeScript, etc.) and their roles.

5. `_docs/planning/milestones/00-initial-milestones/definition/ui-rules.md`

   - Define visual and interaction guidelines for building components (including design principles and component behaviors).

6. `_docs/planning/milestones/00-initial-milestones/definition/theme-rules.md`

   - Establish theming foundations (colors, typography, etc) to be incorporated into UI development.

7. `_docs/planning/milestones/00-initial-milestones/definition/project-rules.md`
...
```
Use @_docs/planning/milestones/00-initial-milestones/project-overview/overview.md to create a document at `_docs/planning/milestones/00-initial-milestones/definition/user-flow.md`, which should define the user journey through different segments of the application.
...
```
Use @_docs/planning/milestones/00-initial-milestones/project-overview/overview.md and @_docs/planning/milestones/00-initial-milestones/definition/user-flow.md to create a document at `_docs/planning/milestones/00-initial-milestones/definition/auth.md`, which describes how authentication works in the app.
```
...
```
Use @_docs/planning/milestones/00-initial-milestones/project-overview/overview.md, @_docs/planning/milestones/00-initial-milestones/definition/user-flow.md, and @_docs/planning/milestones/00-initial-milestones/definition/auth.md to make recommendations for our stack. I already know I want to use ___, ___, and ___ (e.g. TypeScript, React, Tailwind).
...
4. USER ACTION: Look through the proposed stack and think about what you want to pick. For ones you're unsure of, ask about pros/cons, see what's most compatible with the rest of the stack, etc. When you're done, ask the AI to output the decisions in `_docs/planning/milestones/00-initial-milestones/definition/tech-stack.md`.

5. PROMPT:

```
Update @_docs/planning/milestones/00-initial-milestones/definition/tech-stack.md to cover all best-practices, limitations, and conventions for using the selected technologies. It should be thorough, and include important considerations and common pitfalls for each one.
```
...
Observe @_docs/planning/milestones/00-initial-milestones/project-overview/overview.md and @_docs/planning/milestones/00-initial-milestones/definition/user-flow.md for context about the project to guide your recommendations.
```
...
Use @_docs/planning/milestones/00-initial-milestones/project-overview/overview.md, @_docs/planning/milestones/00-initial-milestones/definition/user-flow.md, and @_docs/planning/milestones/00-initial-milestones/definition/tech-stack.md to put together two new files: `_docs/planning/milestones/00-initial-milestones/definition/ui-rules.md` and `_docs/planning/milestones/00-initial-milestones/definition/theme-rules.md`. The former should focus on common design principles for our application to follow, while the latter should outline all the colors and styles we're using to create a consistent theme across our application.
```
...
Use @_docs/planning/milestones/00-initial-milestones/definition/tech-stack.md, @_docs/planning/milestones/00-initial-milestones/definition/user-flow.md, @_docs/planning/milestones/00-initial-milestones/project-overview/overview.md, @_docs/planning/milestones/00-initial-milestones/definition/auth.md, @_docs/planning/milestones/00-initial-milestones/definition/ui-rules.md, and @_docs/planning/milestones/00-initial-milestones/definition/theme-rules.md to put together a new file at `_docs/planning/milestones/00-initial-milestones/definition/project-rules.md`, which touches on our project's directory structure, file naming conventions, and any other rules we need to follow.
```
...
Review @_docs/planning/milestones/00-initial-milestones/project-overview/overview.md, @_docs/planning/milestones/00-initial-milestones/definition/user-flow.md, @_docs/planning/milestones/00-initial-milestones/definition/auth.md, @_docs/planning/milestones/00-initial-milestones/definition/tech-stack.md, and @_docs/planning/milestones/00-initial-milestones/definition/project-rules.md to gather relevant context about the project and its features.
```

10. USER ACTION: Make a brief Agent Rules file, which will be a list of rules for the agent to follow (duh). It's recommended that you place this in your Cursor User Rules (CMD + Shift + P > Cursor Settings > Rules > User Rules), and/or make a Cursor Notepad (There should be a section in the bottom left corner of your file tree. If not, use the same command as above to navigate to Cursor Settings and enable Notepads in the "Beta" section). The content will be similar to `_docs/planning/milestones/00-initial-milestones/definition/project-rules.md`, but auto-attached to every prompt (if you put it in User Rules) or attached at-will if you take the Cursor Notepad approach.
...
```
Using @_docs/planning/milestones/00-initial-milestones/project-overview/overview.md, @_docs/planning/milestones/00-initial-milestones/definition/user-flow.md, @_docs/planning/milestones/00-initial-milestones/definition/auth.md, @_docs/planning/milestones/00-initial-milestones/definition/tech-stack.md, and @_docs/planning/milestones/00-initial-milestones/definition/project-rules.md, perform an initial update to our README to give a brief overview of our project and its conventions.
```

12. USER ACTION: Make sure all these docs are in the right place:
   - Project overview: `_docs/planning/milestones/00-initial-milestones/project-overview/` (e.g. `overview.md`).
   - Definition docs (user-flow, auth, tech-stack, ui-rules, theme-rules, project-rules): `_docs/planning/milestones/00-initial-milestones/definition/`.
...
13. ATTACH: Agent Rules (the Notepad, if you made one), the first milestone's phase and phase-plan doc(s) (e.g. `_docs/milestones/01-setup/phases/01-scaffold.md`, `_docs/milestones/01-setup/phase-plans/01-scaffold.md`), `_docs/planning/milestones/00-initial-milestones/definition/tech-stack.md`, and `_docs/planning/milestones/00-initial-milestones/project-overview/overview.md`.
