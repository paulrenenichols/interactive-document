...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const base =
      'inline-flex items-center justify-center gap-2 rounded-radius-medium px-4 py-2 text-sm font-medium transition-opacity focus:outline-none focus-visible:ring-2 focus-visible:ring-border-focus focus-visible:ring-offset-2';
    return (
      <button
        ref={ref}
        type="button"
