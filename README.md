...
- **Usage:** In Cursor Agent chat, ask **"help"** or **"what can you do?"** for a full list of capabilities. Key workflows:
  - Setup / convert / upgrade docs
  - Create or update explorations
  - Create milestone from exploration
  - Make milestone active / mark milestone completed
